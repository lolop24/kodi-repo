...
DETAIL_CACHE_TTL = 20 * 60 * 60
SEARCH_CACHE_TTL = 30 * 24 * 60 * 60
SOURCE_CACHE_TTL = 20 * 60 * 60
SOURCE_WIDGET_FALLBACK_TTL = 20 * 60 * 60
MAX_WORKERS = 4
PREWARM_WIDGET_LIMIT = 15
PREWARM_SOURCES = (
    'movies_new_dubbed',
    'movies_new',
    'series_new',
...
def log(message, level=xbmc.LOGINFO):
    xbmc.log('[Kolop Lite] %s' % message, level)
...
def _get_limit():
    try:
        value = int(ADDON.getSetting('item_limit') or '15')
    except ValueError:
        value = 15
